Write-Host ""
Write-Host "========================================"
Write-Host " BiznessHunter - Radar 31"
Write-Host " VERDICT CALIBRATION"
Write-Host "========================================"
Write-Host ""

$raw = Get-Content .\radar30_opportunities.json -Raw | ConvertFrom-Json
$items = @($raw)
...
$feed |
    ...
    Set-Content .\radar31_opportunities.json -Encoding UTF8

Write-Host ""
Write-Host "Output : .\radar31_opportunities.json"
Write-Host ""
