Write-Host ""
Write-Host "========================================"
Write-Host " BiznessHunter - Radar 25"
Write-Host " ECONOMIC FIT"
Write-Host "========================================"
Write-Host ""
...
$feed |
    ...
    Set-Content .\radar25_opportunities.json -Encoding UTF8

Write-Host ""
Write-Host "Output : .\radar25_opportunities.json"
Write-Host ""
