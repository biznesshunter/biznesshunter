Write-Host ""
Write-Host "========================================"
Write-Host " BiznessHunter - Radar 24"
Write-Host " LAUNCH ECONOMICS"
Write-Host "========================================"
Write-Host ""

$raw = Get-Content .\radar23_opportunities.json -Raw | ConvertFrom-Json
$items = @($raw)
...
$feed |
    ...
    Set-Content .\radar24_opportunities.json -Encoding UTF8

Write-Host ""
Write-Host "Output : .\radar24_opportunities.json"
Write-Host ""
