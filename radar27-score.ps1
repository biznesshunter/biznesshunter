Write-Host ""
Write-Host "========================================"
Write-Host " BiznessHunter - Radar 27"
Write-Host " ECONOMIC FIT V2"
Write-Host "========================================"
Write-Host ""
...
$feed |
    ...
    Set-Content .\radar27_opportunities.json -Encoding UTF8

Write-Host ""
Write-Host "Output : .\radar27_opportunities.json"
Write-Host ""
