Write-Host ""
Write-Host "========================================"
Write-Host " BiznessHunter - Radar 28"
Write-Host " WILLINGNESS V2"
Write-Host "========================================"
Write-Host ""
...
$feed |
    ...
    Set-Content .\radar28_opportunities.json -Encoding UTF8

Write-Host ""
Write-Host "Output : .\radar28_opportunities.json"
Write-Host ""
